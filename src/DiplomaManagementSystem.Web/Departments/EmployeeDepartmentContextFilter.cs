...
using DiplomaManagementSystem.Web.Areas.Employee.Controllers;
...
internal sealed class EmployeeDepartmentContextFilter(IDepartmentContextService departmentContextService) : IAsyncActionFilter
{
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        IActionResult? redirect = await departmentContextService.EnsureEmployeeContextAsync(
            context.HttpContext,
            userId,
